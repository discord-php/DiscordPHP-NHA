...
class Commands
{
    ...
    public function __construct(
        ...
        $this->helpGuide = new HelpGuide($nha);
    }
    ...
    /**
     * How-to-play guide sections. Kept as an alias so `Commands::HELP` callers
     * keep working; the content and rendering live in {@see HelpGuide}.
     *
     * @var array<string, array{0: string, 1: string, 2: string}>
     */
    public const HELP = HelpGuide::SECTIONS;
