 ...
 *
 * The deterministic ladder ({@see suggestion()}) also lives here — it is the
 * fallback {@see AutoPlayer} drops to when a pick is refused, and the "SUGGESTED
 * next action" line {@see PromptBuilder} shows the model.
 *
